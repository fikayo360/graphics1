    ...
    return (
        <section id="hero" ref={container}>
           { navActive? (<div id='navMobile' onClick={toggleMobileNav} ref={ref} >
            ...
            <div id='heroOther'>
                <p> <span id='txtG'>First impression photography.</span><span className='hIc'><img src='profile.png' /></span> we are exceptional photographer based in lagos state nigeria...
                </p>
